    ...
    return (
        <div className={styles.resultContainer}>
            ...
            <div className={styles.resultActions}>
                <button className={styles.pdfBtn} onClick={onDownloadPDF} id="download-pdf-btn">
                ...
                <button className={styles.reviewBtn} onClick={onShowReview} id="review-answers-btn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button className={styles.retryBtn} onClick={onRetry} id="retry-exam-btn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
