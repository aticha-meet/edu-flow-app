...
import { ExamQuestion } from '@/app/exam/page'
    ...
    return (
        <div className={styles.reviewContainer}>
            ...
            {examData.map((q, index) => {
                ...
                return (
                    <div className={styles.questionCard} key={q.questionID} id={`review-question-${index}`}>
            ...
            <div className={styles.resultActions}>
                <button className={styles.pdfBtn} onClick={onDownloadPDF} id="review-download-pdf-btn">
                ...
                <button className={styles.retryBtn} onClick={onBackToResult} id="back-to-result-btn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button className={styles.retryBtn} onClick={onRetry} id="review-retry-btn">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
