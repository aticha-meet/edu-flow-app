  ...
  const handleCreateClass = async (e: React.FormEvent) => {
    ...
    try {
      await createCourse({
        ...
        maxStudents: formData.maxStudents || 50,
      ...
      const msg =
        err?.response?.data?.message || 'เกิดข้อผิดพลาดในการสร้างรายวิชา';
      setFormError(msg);
    } finally {
      ...
      >
        ...
        <div className={styles?.modalHeader}>
          ...
          <p className={styles?.modalSubtitle}>
            กรอกข้อมูลรายวิชาที่ต้องการสร้าง
          </p>
        </div>
        ...
        <form onSubmit={handleCreateClass} className={styles?.modalForm}>
          ...
          <div className={styles?.formGroup}>
            ...
            <input
              ...
              name="code"
              className={styles?.formInput}
              placeholder="เช่น CS101 (ไม่จำเป็นต้องกรอก)"
              value={formData.code || ''}
              onChange={handleInputChange}
            />
          </div>
