    ...
    <div className={styles.settingsPage}>
      ...
      <div className={styles.settingsSection}>
        <div className={styles.settingsSectionHeader}>
          ...
          <div>
            <h3 className={styles.settingsSectionTitle}>Course Configuration</h3>
            <p className={styles.settingsSectionSubtitle}>ปรับแต่งข้อมูลและตั้งค่าของรายวิชา</p>
          </div>
        </div>
        ...
        <div className={styles.settingsCard}>
          <div className={styles.settingsFormGrid}>
            ...
            {/* Course Name */}
            <div className={styles.settingsFormGroup} style={{ gridColumn: '1 / -1' }}>
              <label className={styles.settingsLabel} htmlFor="settings-className">
            ...
            {/* Description */}
            <div className={styles.settingsFormGroup} style={{ gridColumn: '1 / -1' }}>
              <label className={styles.settingsLabel} htmlFor="settings-description">
                คำอธิบายรายวิชา
              </label>
              <textarea
            ...
            {/* Max Students */}
            <div className={styles.settingsFormGroup}>
              <label className={styles.settingsLabel} htmlFor="settings-maxStudents">
                จำนวนนักศึกษาสูงสุด
              </label>
              <input
        ...
        >
          <div className={styles.dangerZoneToggleLeft}>
            ...
            <div>
              ...
              <span className={styles.dangerZoneSubtitle}>การดำเนินการที่ไม่สามารถย้อนกลับได้</span>
            </div>
          </div>
          <svg
            width="14"
              ...
              <div className={styles.dangerDeleteHeader}>
                ...
                <div>
                  ...
                  <p className={styles.dangerDeleteDesc}>
                    การลบจะลบข้อมูลทั้งหมดที่เกี่ยวข้องกับรายวิชานี้อย่างถาวร ได้แก่ บันทึก syllabus,
                    การสมัครเรียนของนักศึกษา และแบบทดสอบทั้งหมด
                  </p>
                </div>
              </div>

              <div className={styles.dangerConfirmBox}>
                <label className={styles.dangerConfirmLabel} htmlFor="delete-confirm-input">
                  พิมพ์{' '}
                  <code className={styles.dangerConfirmCode}>{course.className}</code>
                  {' '}เพื่อยืนยันการลบ
                </label>
                <input
