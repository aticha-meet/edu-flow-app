...
export default function ClassPage() {
    ...
    const fetchClasses = async () => {
        ...
        try {
            ...
            const data = await getListClasses('/class', {}, {
    ...
    useEffect(() => {
        if (sessionFromStore) fetchClasses();
    }, [sessionFromStore]);
    ...
    const handleCreateClass = async (e: React.FormEvent) => {
        ...
        if (!formData.teacherId.trim()) {
            setFormError('กรุณากรอก Teacher ID');
            return;
        }
        ...
        <div className={styles.page}>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.header}>
                    ...
                    {isAdmin && (
                        <button className={styles.addBtn} id="add-class-btn" onClick={handleOpenModal}>
                ...
                <div className={styles.statsRow}>
                    <div className={styles.statCard}>
                        <span className={styles.statValue}>{isLoading ? '—' : classes.length}</span>
                    ...
                    <div className={styles.statCard}>
                        <span className={styles.statValue}>{isLoading ? '—' : totalStudents.toLocaleString()}</span>
                ...
                {isLoading ? (
                    ...
                    <div className={styles.grid}>
                        {filtered.map((cls) => (
                            <div key={cls.id} className={styles.card} id={`class-card-${cls.id}`}>
                                {/* Color accent bar */}
                                ...
                                <div className={styles.cardBody}>
                                    ...
                                    <div className={styles.cardTop}>
                                        <span className={styles.classCode} style={{ color: cls.color }}>{cls.code}</span>
                                        <span className={`${styles.badge} ${styles[`badge_${cls.status}`]}`}>
                                    ...
                                    <div className={styles.progressSection}>
                                        <div className={styles.progressLabel}>
                                            <span>นักศึกษา</span>
                                            <span style={{ color: cls.color }}>{cls.students} / {cls.maxStudents}</span>
                                        </div>
                                ...
                                <div className={styles.cardFooter}>
                                    <button className={styles.detailBtn} style={{ '--accent': cls.color } as React.CSSProperties}>
                                        ดูรายละเอียด
                        ...
                        <form onSubmit={handleCreateClass} className={styles.modalForm}>
                            ...
                            <div className={styles.formGroup}>
                                <label htmlFor="teacherId" className={styles.formLabel}>
                                    Teacher ID <span className={styles.required}>*</span>
                                </label>
                                <input
                                    type="text"
                                    id="teacherId"
